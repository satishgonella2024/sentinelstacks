...
# Script to build a minimal version of the project for testing
set -e  # Exit on error

echo "Building minimal test..."

# Create a test file in the main project directory
TEST_FILE="minimal_dag_test.go"

# Create a simple self-contained test file
cat > $TEST_FILE << 'EOF'
package main
...
echo "Building and running self-contained test..."
go build -o minimal_test $TEST_FILE
./minimal_test
